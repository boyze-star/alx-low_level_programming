 ...
 * @fd: filke descriptor to be closed
 */
void close_file(int fd)
{
	int c;
 ...
 * Return: 0(Success)
 *
 * Description: incorrect arguement count - exit code 97
 * file_to cannot be created or written to - exit code 99
 * file_from cannot be read or doesn't exist - 98
 * file_to or file_from cannot close - exit code 100
 */
